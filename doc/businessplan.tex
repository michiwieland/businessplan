...
GitFit wird als Abomodell angeboten, wobei die Abokosten monatlich entrichtet werden müssen. Dies erlaubt es bei insolventen Kunden schnell und unkompliziert die Partnerschaft aufzulösen. Die Kosten werden an den aktiven Account in einem Fitnesscenter gemessen. Somit korreliert der Produtkpreis mit der grösse des Fitnesscenter und kleinere Anbieter können sich das Produkt immer noch leisten.
...
\begin{table}[h]
	...
	\begin{tabu} to \linewidth {l r}
		...
		Zugang zu praxiserprobten Trainingspläne (einmalig) & 200 \\
		Austattung der Fitnessgeräte mit QR Codes (einmalig) & 500  \\
		\midrule
		\textbf{Total} & \textbf{1600} \\
		\bottomrule 
	\end{tabu} 
